    ...
    function render($settings=array()) {
        ...
        switch( $this->settings['type']):
            case 'image':
                ...
                echo $this->Form->input( $this->settings['model'].'.'. $this->settings['field'], array('autocomplete'=>'off','label'=> $this->settings['clabel'],'class'=>'form-control'));
            break;
            case 'math':
                ...
                echo $this->Form->input( $this->settings['model'].'.'. $this->settings['field'],array('autocomplete'=>'off','label'=>false,'div'=>false,'class'=>'form-control'));
            break;
        endswitch;
    }
}