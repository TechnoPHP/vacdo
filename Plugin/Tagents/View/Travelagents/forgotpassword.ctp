...
<div class="row">
	<div class="col-md-6">
		...
		<?php echo $this->Form->create('Aagent', array("url"=>array("plugin"=>"tagents","controller"=>"aagents","action"=>"forgotpassword","admin"=>false),'role'=>'form'));?>
		...
		<div class="row">
			...
			<div class="">						
				<?php echo $this->Html->link("<b>Not a memeber? Join us</b>", array('plugin'=>'tagents','controller'=>'aagents','action'=>'register','admin'=>false),array('class'=>'btn pull-right','escape'=>false)); ?>
			</div>
		</div>
