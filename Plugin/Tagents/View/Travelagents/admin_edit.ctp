...
<section id="main-content">
	<section class="wrapper">
		<div class="row">
			<div class="col-lg-12">
				<div class="card">
					<div class="card-header"><h6>Update Agent<?php echo $this->Html->link("Back to list", array("plugin"=>"tagents","controller"=>"aagents","action"=>"index","admin"=>true),array("class"=>"btn btn-sm btn-outline-info float-right")); ?></h6>
					</div>
					<div class="row">
						<div class="col-md-6">						
							<div class="card-body">
								...
								<div class="row">
									...
									<div class="col-md-6">
										...
										<label for="Region">Region</label>
											<?php echo $this->Form->select('User.region_id','',array("class"=>"form-control","empty"=>"--Region--")); ?>
										</div>
									</div>
								</div>
								<div class="row">
