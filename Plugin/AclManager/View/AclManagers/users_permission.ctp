...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var tableAros = $('#tbl_aros').DataTable({
            ...
            "sAjaxSource": "<?php echo Router::url(array('controller' => 'AclManagers', 'action' => 'ajaxListUsersAcos')) ?>",
            "order": [[ 1, "asc" ]],
            "bPaginate": false,
            "columns": [

                { "data": "Aco.id",'class':'td_id' },
                { "data": "Aco.path",'class':'td_name' },
                {
                    "class":          "td_options",
                    "orderable":      false,
                    'sortable':false,
                ...
                },
                {
                    ...
                    render: function ( data, type, row ) {
                        if ( type === 'display' ) {
                            ...
                            return '<input type="checkbox" name="data[AclAcosAro][acoID][]" class="selectedAcos" value="'+data.Aco.id+'">';
                        }
                        return data;
                    },
                 ...
                 "fnServerParams": function ( aoData ) {
                    aoData.push( { "name": "admin_id", "value": '<?php echo $userID; ?>' } );
                },
                ...
                "fnCreatedRow": function(nRow, aData, iDataIndex){
                    ...
                    ?>
                     ...
                     var buttonReset = $('<button type="button" class="btn btn-primary btn-circle btn-xs"  role="button" data-toggle="tooltip" data-placement="top" title="<?php echo __('Reset Permissions (Inherit Group)'); ?>"><span class="glyphicon glyphicon-erase" aria-hidden="true"></span></button>').tooltip();

                        buttonReset.on('click',function(e){
                            e.preventDefault;
                            setPermission(aData.Aco.id,'P');

                            return false;
                        });
                     $('td.td_options', nRow).append(buttonReset);
                },
        ...
        function messageType(valor){
            switch(parseInt(valor)){
                case 0:
                    tipo = '<?php echo __('Not defined yet (Group Legacy)'); ?>';
                    break;
                case 1:
...
<div class='row'>
    <div class='col-md-12'>
        ...
        <div class="panel panel-default">
            <header class='panel-heading'><?php echo __('Management Permissions').' - '.__('Users'); ?></header>
                        ...
                        <thead>
                            <tr>
                                ...
                                <?php
                                    ...
                                    echo $this->Form->button('<span class="glyphicon glyphicon-erase"></span>', array(
                                        'class'=>'btn btn-primary  btn-xs btn-crud',
                                        'role'=>'button',
                                        'data-toggle'=>'tooltip',
                                        'data-placement'=>'top',
                                        'title'=>__('Reset Permissions'),
                                        'aria-hidden'=>true,
                                        'id'=>'btnResetAll',
                                        'type'=>'button',
                                    ));
