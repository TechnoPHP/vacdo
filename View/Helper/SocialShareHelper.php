...
class SocialShareHelper extends Helper
{
    ...
    protected $_urls = [
		...
		'facebook' => 'https://www.facebook.com/dialog/share?app_id=790887897625172&display=page&href={url}&redirect_uri={url}',
     ...
     * @return string URL.
     */
    public function fa($service, $labelText,$url = null, array $options = [])
    {
        $defaults = [
            'target' => $this->_config['target']
        ];
