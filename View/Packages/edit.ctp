			...
			<div class="col-lg-12">
				<div class="card">
					...
					<div class="row">
						<div class="col-md-6">						
							<div class="card-body">
								<?php echo $this->Form->create('Package', array("url"=>array("plugin"=>"tagents","controller"=>"packages","action"=>"edit","admin"=>false),"role"=>"form","class"=>""));?>
								...
								<div class="row">
									<div class="col-md-12 form-group">
										<?php echo $this->Form->input('Packagetype', array('multiple'=>'checkbox', 'label'=>false, 'type'=>'select','div'=>false,'separator'=>'&nbsp;','options'=>$packagetypes)); ?>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12 form-group">
										<?php echo $this->Form->input('Holidaytheme', array('multiple'=>'checkbox', 'label'=>false, 'type'=>'select','separator'=>'&nbsp;','options'=>$holidaythemes,'before' => '<label>Assign suitable Holiday themes</lablel>')); ?>
									</div>
								</div>
								<div class="row">
									<div class="col-md-6">
