<div class="body-content py-3">
	...
	<div class="card-body">
		...
		<h3>Contact Us</h3>
		<p>If you have any questions about this Agreement, please contact us filling this <?php echo $this->Html->link("Contact Us",array('plugin'=>false,'controller'=>'pages','action'=>'contactus','admin'=>false));?></p>
	</div>
</div>			</div><!-- /.row -->
		</div><!-- /.sigin-in-->
		<!-- ============================================== BRANDS CAROUSEL ============================================== -->
