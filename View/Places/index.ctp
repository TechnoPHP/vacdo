<?php $this->assign('title','Articles published by Chirayu Bhatt');  ?>
<div class="contain">
	<div class="row">
		<div class="col-md-3 form-group">
			<?php echo $this->Form->create("",array('url'=>array('controller'=>'posts','action'=>'searchfull','admin'=>false),array('class'=>'form-inline'))); ?>
			<?php echo $this->Form->text('Post.fullsearch',array("type"=>"text","class"=>"col-md-12 form-control")); ?></div>
					...
					<div class="artical_box">
						...
						<div class="artical_content">
							...
							<div class="artical_thum_date"> 
								<?php echo $this->Time->nicedate($post['Post']['created']); ?> 
							</div>
							<div class="comment">
	...
	<ul class="pagination">
		<?php $this->Paginator->options(array('url'=>array('controller'=> 'posts','action'=>'index')));
