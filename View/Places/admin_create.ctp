				...
				<div class="col-md-12 col-xl-12">
					<div class="card">
						...
						<div class="card-body">
							...
							<?php echo $this->Form->create('Destination', array("url"=>array("controller"=>"destinations",'action' => 'create','admin'=>true),'type'=>'file'));?>
								<div class="row">
								...
								<div class="row">
									<div class="col-md-12 form-group">
										...
										<?php echo $this->Form->input('Destination.image', array('type'=>'file',"class"=>"file", "data-max-file-count"=>"1", "label"=>false)); ?>
									</div>
								</div>
								<div class="row">
									<div class="col-md-12 form-group">
