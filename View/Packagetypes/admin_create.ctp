			...
			<div class="row">
				<div class="col-md-12 col-xl-12">
					<div class="card">
						...
						<div class="card-body">
							<?php echo $this->Form->create('Packagetype', array("url"=>array("plugin"=>"","controller"=>"packagetypes","action"=>"create","admin"=>true),"role"=>"form","class"=>""));	?>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<?php echo $this->Form->text('Packagetype.name',array("class"=>"form-control","placeholder"=>"Packagetype name")); 
										echo $this->Form->erro('Packagetype.name');
										?>
									</div>
								</div>
							</div>
